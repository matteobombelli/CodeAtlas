# Milestone 3 prompt — Spring endpoints

Recognize Spring stereotypes, JPA entities, Spring Data repositories,
constructor injection, and HTTP mappings.

Combine class and method paths; support composed mapping annotations, path/value
