...
- local project directories under approved roots;
...
project declarations. Content hashes and a snapshot re-check prevent a changing
source tree from being presented as current.
